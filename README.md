...
[![GitHub license](https://img.shields.io/github/license/pclark-582c9/OpenAPI-Freeapi)](https://github.com/pclark-582c9/OpenAPI-Freeapi)
...
## 📌 核心优势
- **多模聚合**：覆盖通义千问、文心一言、讯飞星火、GLM、Deepseek 等 100+ 主流 AI 模型，无需逐个对接
...
fetch('https://zypwtohm.ap-northeast-1.clawcloudrun.com/v1/chat/completions', {
  ...
  body: JSON.stringify({
    model: 'tongyi/qwen-max', // 模型标识（参考下方列表）
    messages: [
